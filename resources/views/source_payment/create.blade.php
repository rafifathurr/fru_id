        ...
        <div class="main-panel">
            <div class="content">
                ...
                <section class="container">
                    <form id="form_add" action="{{ route('source_payment.' . $url) }}" method="post" enctype="multipart/form-data" style="margin-right:100px;">
                    {{ csrf_field() }}
                        <br>
                        <div class="row">
                            <div class="col-md-10">
                            ...
                            <div style="float:right;">
                                @if ($title == 'Add Source Payment')
                                    <div class="col-md-10" style="margin-right: 20px;">
                                        <a href="{{ route('source_payment.index')}}" type="button" class="btn btn-danger">
