                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="sumber" id="sumber" class="form-control"  step="1" @if (isset($suppliers)) value="{{ $suppliers->supplier }}" @endisset autocomplete="off" required {{ $disabled_ }} style="width:100%;">
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" name="note" id="note" rows="5" cols="10" @if (isset($suppliers)) value="{{ $suppliers->note }}" @endisset autocomplete="off" {{ $disabled_ }} style="width:100%"></textarea>
                                </div>
                            </div>
                        </div>
                        <br>
